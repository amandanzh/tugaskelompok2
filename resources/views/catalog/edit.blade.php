          ...
          <div class="white-box">
            ...
            <form action="{{ route('katalog.update', $data->id) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control @error('harga') is-invalid @enderror" id="" name="harga" value="{{ old('harga', $data->harga) }}">
                @error('harga')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
              ...
              <div class="mb-3">
                <label for="telepon" class="form-label">Gambar Baru</label>
               ...
               <a href="{{ route('katalog.index') }}" class="btn btn-secondary btn-sm text-white " value="ubah">
